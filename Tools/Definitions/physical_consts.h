...
// atomic data for HI
//-------------------------------------------------------------------------------------------------------
//const double const_HI_A2s_1s_0 = 8.22458;       // Hydrogen 2s decay rate (old Recfast value)
const double const_HI_A2s_1s_0 =8.2206;           // Hydrogen 2s decay rate (Labzowsky et al. 2005)
extern double const_HI_A2s_1s;                    // used as globally accessable variable
...
//-------------------------------------------------------------------------------------------------------
const double const_HeI_A2s_1s_0 = 51.3 ;          // HeI 2s-1s two photon rate in [s^-1] ( Drake (1969) )
extern double const_HeI_A2s_1s;                   // used as globally accessible variable
...
//-------------------------------------------------------------------------------------------------------
//const double const_HeII_A2s_1s = 526.5;         // Helium II 2s-1s two-photon decay rate (Recfast value)
const double const_HeII_A2s_1s = 526.57;          // Helium II 2s-1s two-photon decay rate
